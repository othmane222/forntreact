        ...
        <div id="features" className={"text-black"}>
            <Container>
                <div class="md:w-2/3 lg:w-1/2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-secondary fill-amber-500">
                ...
                >
                    <div class="group relative bg-secondary-3 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                    ...
                    <div
                        class="group relative bg-secondary-3 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10"
                    >
                        <div
